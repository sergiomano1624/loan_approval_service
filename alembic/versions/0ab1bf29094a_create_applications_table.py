...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("loan_amount", sa.String(255), unique=False, nullable=True),
        sa.Column("term", sa.String(255), unique=False, nullable=True),
        sa.Column("interest", sa.String(255), unique=False, nullable=True),
        sa.Column("repayment_period", sa.String(255), unique=False, nullable=True),
        sa.Column("trn_no", sa.String(255), nullable=False),
        sa.Column("monthly_income", sa.String(255), nullable=False),
